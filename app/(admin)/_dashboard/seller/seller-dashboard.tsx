...
import { getSellerDashboard } from "@/features/dashboard/seller-dashboard.service";
      ...
      <section className="grid grid-cols-1 gap-4 bg-white">
        <div className="rounded-2xl border p-4 shadow-sm">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-base font-semibold">Évolution de mes ventes</h2>
          </div>
          <Suspense>
